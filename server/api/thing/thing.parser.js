...
exports.parse = function(req, res) {
  var urlInfo = url.parse(req.body.url);
  /**
   * { protocol: 'http:',
      slashes: true,
      auth: null,
      ...
      query: 'id=3408565637&spm=a230r.1.14.3.6awLvr&ad_id=&am_id=&cm_id=140105335569ed55e27b&pm_id=',
      pathname: '/item.htm',
  ...
  var parser = new Parser(urlInfo.href);
